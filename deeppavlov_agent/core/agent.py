...
class Agent:
    ...
    async def register_msg(self, utterance: str, user_external_id: Hashable,
                           user_device_type: Any, location: Any,
                           channel_type: str, deadline_timestamp=None,
                           require_response=False, **kwargs):
        dialog = await self.state_manager.get_or_create_dialog_by_tg_id(user_external_id, channel_type)
