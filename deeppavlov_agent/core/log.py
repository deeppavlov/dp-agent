...
def init_logger():
    ...
    configured_loggers = [log_config.get("root", {})] + [logger for logger in log_config.get("loggers", {}).values()]
...
class LocalResponseLogger(BaseResponseLogger):
    ...
    def get_current_load(self):
        ...
        response = {"current_load": dict(self._services_load), "response_time": response_time}
        return response
